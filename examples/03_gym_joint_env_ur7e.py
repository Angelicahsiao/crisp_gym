"""Control the joints using the ManipulatorJointEnv interactively with a UR7e robot.

Uses a pure-YAML environment config — no Python config class needed.
...
print("Controls: [a] rotate -, [d] rotate +, [s] switch joint, [e] exit\n")
